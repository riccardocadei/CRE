...
install_github("fasrc/CRE", ref="develop")
library(CRE)
```
...
- Go to package [Github repository](https://github.com/fasrc/CRE) and from the 
...
project. Go to package [Github repository](https://github.com/fasrc/CRE) and 
