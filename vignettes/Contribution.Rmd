...
- Navigate to CRE Github [repository](https://github.com/fasrc/CRE), and at the top right corner, click on the `Fork` button. This will add a clone of the project to your Github account.
...
Please report potential bugs by creating a [new issue](https://github.com/fasrc/CRE/issues) or sending us an email. Please include the following information in your bug report:
