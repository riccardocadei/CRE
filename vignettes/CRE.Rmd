...
__Method Parameters (not required)__    
Parameters for estimating the individual treatment effect, including:
- **`ratio_dis`** The ratio of data delegated to the discovery sub-sample (default: 0.5). 
__Parameters for Discovery__           
- **`ite_method_dis`** The method to estimate the discovery sub-sample in estimating individual treatment effect (ITE) (default: 'aipw').    
...
__Hyper Parameters (not required)__     
The list of parameters required to tune the functions, including
