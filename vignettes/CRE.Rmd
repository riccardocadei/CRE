...
__Parameters for Honest Splitting__
...
- **`t_pvalue`** The threshold to define statistically significant rules (filter 
only causal decision rules with p-value <= t_pvalue).
...
```R
 ...
 hyper_params = list(interaction_vars = c(),
                     ntrees_rf = 100,
                     ntrees_gbm = 50,
                     node_size = 20,
                     max_nodes = 5,
