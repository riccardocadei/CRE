test_that("AIPW ITE Estimated Correctly", {
  ...
  expect_equal(ite_result[1], 0.5557903, tolerance = 0.00001)
  expect_equal(ite_result[11], 0.6201689, tolerance = 0.00001)
  expect_equal(ite_result[91], 0.3326752, tolerance = 0.00001)
})
