test_that("IPW ITE Estimated Correctly", {
  ...
  suppressWarnings(expect_error(estimate_ite_ipw(y = "test", z, X)))
  suppressWarnings(expect_error(estimate_ite_ipw(y, z = "test", X)))
  suppressWarnings(expect_error(estimate_ite_ipw(y, z, X = "test")))
