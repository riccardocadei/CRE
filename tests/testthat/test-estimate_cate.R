...
#
#   # Incorrect inputs
#   expect_error(estimate_cate(y_inf, z_inf, X_inf, X_names,
#                              include_offset, offset_name,
#                              rules_matrix_inf, select_rules_interpretable,
#                              cate_method, ite_inf, sd_ite_inf = "test", cate_SL_library,
#                              filter_cate))
#
#   # Correct outputs
#   cate_inf <- estimate_cate(y_inf, z_inf, X_inf, X_names, include_offset,
...
test_that("CATE (cf-means) Estimation Runs Correctly", {
  ...
  # No significant rules were discovered.
  expect_equal(length(select_rules_dis), 0)
